...
import static com.asdtechlabs.bloodbank.PostSignIn.isCheck;
import static com.asdtechlabs.bloodbank.RequestScreen.alertDialog;
import static com.asdtechlabs.bloodbank.RequestScreen.location;
import static com.asdtechlabs.bloodbank.RequestScreen.nameOfPlace;
import static com.asdtechlabs.bloodbank.RequestScreen.recyclerView;
import static com.google.android.libraries.places.api.model.TypeFilter.ADDRESS;
...
public class PlacesAutoCompleteAdapter extends RecyclerView.Adapter<PlacesAutoCompleteAdapter.PredictionHolder> implements Filterable {
    ...
    public class PredictionHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            PlaceAutocomplete item = getItem(getAdapterPosition());
            if (v.getId() == R.id.place_item_view) {
                ...
                placesClient.fetchPlace(request).addOnSuccessListener(new OnSuccessListener<FetchPlaceResponse>() {
                    ...
                    public void onSuccess(FetchPlaceResponse response) {
                        ...
                        RequestScreen.isLocation = true;
                        editor = pref.edit();
                        editor.putFloat("geopointLat", (float) place.getLatLng().latitude);
                        editor.putFloat("geopointLon", (float) place.getLatLng().longitude);
                        RequestScreen.locationEntered = new GeoPoint(place.getLatLng().latitude, place.getLatLng().longitude);
                        nameOfPlace = place.getName();
                        editor.apply();
                        RequestScreen.address.setVisibility(View.VISIBLE);
                        RequestScreen.address.setText(place.getAddress());
                        alertDialog.dismiss();
